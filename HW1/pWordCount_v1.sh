...
if [ $# -eq 4 ]
  then
    ...
    #!./pWordCount_v1.sh 
    # 1) 4 = m 'data/alice.txt' \
    # 2) inPutFile = 'wordCount.py' \
    # 3) mapper = 'aggregateCounts_v1.py' \
    # > 'data/alice_pCounts.txt'

    # countfiles = data/alice.txt.chunk.aa.counts data/alice.txt.chunk.ab.counts data/alice.txt.chunk.ac.counts data/alice.txt.chunk.ad.counts
    # m = 4
    # data = data/alice.txt
    # mapper = wordCount.py
    # reducer = aggregateCounts_v1.py
    
    # python python_script.py var1 var2

    # mapper var1 var2
    # line 69 = ./$mapper  < $datachunk > $datachunk.counts &
    # line 87 = cat $countfiles > $data.output

    ./$reducer  < $datachunk > $datachunk.counts &



    python aggregateCounts_v1.py < data/alice_pCounts.txt
